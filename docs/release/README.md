...
|---|---|---|
| Full regression | All automated tests pass | Passed: 116/116 on 2026-08-26 |
...
- [Clean-Machine Validation - RC11](CLEAN_MACHINE_VALIDATION_RC11.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC11](RELEASE_NOTES_1.0.0_RC11.md)
- [Known Limitations - RC11](KNOWN_LIMITATIONS_1.0.0_RC11.md)
...
- [Build Evidence - 1.0.0-rc.11](BUILD_EVIDENCE_1.0.0_RC11.md)
