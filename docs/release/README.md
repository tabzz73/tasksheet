...
|---|---|---|
| Full regression | All automated tests pass | Passed: 102/102 on 2026-08-26 |
...
- [Clean-Machine Validation - RC8](CLEAN_MACHINE_VALIDATION_RC8.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC8](RELEASE_NOTES_1.0.0_RC8.md)
- [Known Limitations - RC8](KNOWN_LIMITATIONS_1.0.0_RC8.md)
...
- [Build Evidence - 1.0.0-rc.8](BUILD_EVIDENCE_1.0.0_RC8.md)
