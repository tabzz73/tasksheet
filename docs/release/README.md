...
|---|---|---|
| Full regression | All automated tests pass | Passed: 95/95 on 2026-08-26 |
...
- [Clean-Machine Validation - RC2](CLEAN_MACHINE_VALIDATION_RC2.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC2](RELEASE_NOTES_1.0.0_RC2.md)
- [Known Limitations - RC2](KNOWN_LIMITATIONS_1.0.0_RC2.md)
...
- [Build Evidence - 1.0.0-rc.2](BUILD_EVIDENCE_1.0.0_RC2.md)
