...
|---|---|---|
| Full regression | All automated tests pass | Passed: 100/100 on 2026-08-26 |
...
- [Clean-Machine Validation - RC6](CLEAN_MACHINE_VALIDATION_RC6.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC6](RELEASE_NOTES_1.0.0_RC6.md)
- [Known Limitations - RC6](KNOWN_LIMITATIONS_1.0.0_RC6.md)
...
- [Build Evidence - 1.0.0-rc.6](BUILD_EVIDENCE_1.0.0_RC6.md)
