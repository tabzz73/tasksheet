...
|---|---|---|
| Full regression | All automated tests pass | Passed: 140/140 on 2026-08-26 |
...
- [Clean-Machine Validation - RC22](CLEAN_MACHINE_VALIDATION_RC22.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC22](RELEASE_NOTES_1.0.0_RC22.md)
- [Known Limitations - RC22](KNOWN_LIMITATIONS_1.0.0_RC22.md)
...
- [Build Evidence - 1.0.0-rc.22](BUILD_EVIDENCE_1.0.0_RC22.md)
