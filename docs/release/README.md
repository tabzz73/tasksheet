...
|---|---|---|
| Full regression | All automated tests pass | Passed: 133/133 on 2026-08-26 |
...
- [Clean-Machine Validation - RC17](CLEAN_MACHINE_VALIDATION_RC17.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC17](RELEASE_NOTES_1.0.0_RC17.md)
- [Known Limitations - RC17](KNOWN_LIMITATIONS_1.0.0_RC17.md)
...
- [Build Evidence - 1.0.0-rc.17](BUILD_EVIDENCE_1.0.0_RC17.md)
