...
|---|---|---|
| Shift-window regression | All automated tests pass | Passed: 91/91 on 2026-08-25 |
...
| Production build | Reproducible web artifact, no TypeScript errors | Passed on 2026-08-25 |
...
- [Clean-Machine Validation](CLEAN_MACHINE_VALIDATION.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes](RELEASE_NOTES_1.0.0_RC1.md)
- [Known Limitations](KNOWN_LIMITATIONS_1.0.0_RC1.md)
...
- [Build Evidence - 1.0.0-rc.1](BUILD_EVIDENCE_1.0.0_RC1.md)
