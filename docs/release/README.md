...
|---|---|---|
| Full regression | All automated tests pass | Passed: 128/128 on 2026-08-26 |
...
- [Clean-Machine Validation - RC16](CLEAN_MACHINE_VALIDATION_RC16.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC16](RELEASE_NOTES_1.0.0_RC16.md)
- [Known Limitations - RC16](KNOWN_LIMITATIONS_1.0.0_RC16.md)
...
- [Build Evidence - 1.0.0-rc.16](BUILD_EVIDENCE_1.0.0_RC16.md)
