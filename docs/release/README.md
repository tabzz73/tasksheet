...
|---|---|---|
| Full regression | All automated tests pass | Passed: 135/135 on 2026-08-26 |
...
- [Clean-Machine Validation - RC18](CLEAN_MACHINE_VALIDATION_RC18.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC18](RELEASE_NOTES_1.0.0_RC18.md)
- [Known Limitations - RC18](KNOWN_LIMITATIONS_1.0.0_RC18.md)
...
- [Build Evidence - 1.0.0-rc.18](BUILD_EVIDENCE_1.0.0_RC18.md)
