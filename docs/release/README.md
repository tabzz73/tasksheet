...
|---|---|---|
| Full regression | All automated tests pass | Passed: 149/149 on 2026-08-27 |
...
- [Clean-Machine Validation - RC24](CLEAN_MACHINE_VALIDATION_RC24.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC24](RELEASE_NOTES_1.0.0_RC24.md)
- [Known Limitations - RC24](KNOWN_LIMITATIONS_1.0.0_RC24.md)
...
- [Build Evidence - 1.0.0-rc.24](BUILD_EVIDENCE_1.0.0_RC24.md)
