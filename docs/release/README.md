...
|---|---|---|
| Full regression | All automated tests pass | Passed: 117/117 on 2026-08-26 |
...
- [Clean-Machine Validation - RC12](CLEAN_MACHINE_VALIDATION_RC12.md)
- [Pilot Acceptance Report](PILOT_ACCEPTANCE_REPORT.md)
- [Release Notes - RC12](RELEASE_NOTES_1.0.0_RC12.md)
- [Known Limitations - RC12](KNOWN_LIMITATIONS_1.0.0_RC12.md)
...
- [Build Evidence - 1.0.0-rc.12](BUILD_EVIDENCE_1.0.0_RC12.md)
