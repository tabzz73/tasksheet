...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className={`relative w-full ${maxWidthClass} bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden my-auto animate-in fade-in zoom-in-95 duration-150`}
